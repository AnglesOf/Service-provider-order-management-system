...
<%@ page import="com.bjpowernode.domain.Orders" %>
...
<div class="cBody">
    <div class="console">
        <form class="layui-form" action="${pageContext.request.contextPath}/orders/searchByOid" method="get">
            <div class="layui-form-item">
                <div class="layui-input-inline">
                    <input type="text" name="o_id" required placeholder="输入ID" autocomplete="off" class="layui-input">
                </div>
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>
                <a href="${pageContext.request.contextPath}/orders/removeOrders?o_id=<%=orders.getO_id()%>">
